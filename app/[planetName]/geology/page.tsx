                ...
                <div className="flex flex-row justify-between mr-16">
                    ...
                    <div className="w-96">
                        ...
                        <div>
                            ...
                            <Link id="linkHover" href={`https://astronomy-nine.vercel.app/${planetName}/geology`} className="flex flex-row border border-[#838391] p-3 w-96 mb-5" style={{ backgroundColor: cor_botoes }}>
