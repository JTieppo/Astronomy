                ...
                <div className="flex flex-row justify-between mr-16">
                    ...
                    <div className="w-96">
                        ...
                        <div>
                            ...
                            <Link id="linkHover" href={`/${planetName}/internal`} className="flex flex-row border border-[#838391] p-3 w-96 mb-5" style={{ backgroundColor: cor_botoes }}>
                                <h3 className="mr-6" style={{ color: "#fff", opacity: "0.5" }}>02</h3>
                                <h3>INTERNAL STRUCTURE</h3>
                            </Link>
                            <Link id="linkHover" href={`/${planetName}/geology`} className="flex flex-row border border-[#838391] p-3 w-96 mb-5">
