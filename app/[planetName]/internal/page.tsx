    ...
    return(
        <div>
            ...
            <div className="flex flex-row justify-between lg:hidden">
                ...
                <div className="w-full border-b-4 ml-4" style={{ borderColor: cor_botoes}}></div>
                <div className="w-full"></div>
            </div>
            ...
            <div className="flex flex-col mt-20 m-10 h-screen lg:mt-0 lg:ml-20 lg:mr-14">
                <div className="flex flex-col m-1 lg:m-14 lg:flex-row justify-between lg:mr-16">
                    ...
                    <div className="lg:w-96">
                        ...
                        <div className="mb-4">
                            <h4 className="text-center lg:text-left">{planetData?.structure.content}</h4>
                        </div>
                        <div className="flex flex-row mb-8">
                            <Link className="flex flex-row mx-auto lg:mx-0" href={planetData?.structure?.source ?? 'defaultSource'} id="wikipedia"><h4 id="source">Source: Wikipedia </h4><img className="ml-3" src="../assets/icon-source.svg" alt="" /></Link>
                        </div>
                        <div className="hidden lg:flex flex-col">
                            ...
                            <Link id="linkHover" href={`/${planetName}/internal`} className="flex flex-row p-3 w-96 mb-5" style={{ backgroundColor: cor_botoes }}>
