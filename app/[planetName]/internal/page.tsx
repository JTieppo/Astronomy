                ...
                <div className="flex flex-row justify-between mr-16">
                    ...
                    <div className="w-96">
                        ...
                        <div className="flex flex-row mb-8">
                            <h4>Source:</h4>
                            <Link className="flex flex-row ml-3" href={planetData?.structure?.source ?? 'defaultSource'} id="wikipedia">Wikipedia <img className="ml-3" src="../assets/icon-source.svg" alt="" /></Link>

                        </div>
                        <div>
                            <Link id="linkHover" href={`https://astronomy-nine.vercel.app/${planetName}`} className="flex flex-row border border-[#838391] p-3 w-96 mb-5">
                                <h3 className="mr-6" style={{ color: "#fff", opacity: "0.5" }}>01</h3>
                                <h3 className="">OVERVIEW</h3>
                            </Link>
                            <Link id="linkHover" href={`https://astronomy-nine.vercel.app/${planetName}/internal`} className="flex flex-row border border-[#838391] p-3 w-96 mb-5" style={{ backgroundColor: cor_botoes }}>
                                <h3 className="mr-6" style={{ color: "#fff", opacity: "0.5" }}>02</h3>
                                <h3>INTERNAL STRUCTURE</h3>
                            </Link>
                            <Link id="linkHover" href={`https://astronomy-nine.vercel.app/${planetName}/geology`} className="flex flex-row border border-[#838391] p-3 w-96 mb-5">
